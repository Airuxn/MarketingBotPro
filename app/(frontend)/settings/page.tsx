      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col gap-6">
        ...
        {true && (
          ...
          <div className="mb-4 border-b border-slate-700/50 pb-2">
            {/* Mobile: Two rows (tabs on top, Storage below) */}
            <div className="lg:hidden space-y-2">
              {/* First row: Overview, Accepted, Edits, Scanned */}
              <div className="flex flex-nowrap items-center justify-between gap-1.5 w-full">
            ...
            {/* Desktop: Single row with all tabs including Storage */}
                        ...
                        <>
                          ...
                          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-2.5 lg:gap-3">
                            ...
                            <div className="glass rounded-lg p-2.5 lg:p-3 border border-slate-700/50 bg-gradient-to-br from-slate-800/50 to-slate-900/30 flex flex-col">
                              ...
                              <div className="pt-1.5 lg:pt-2 mt-1 lg:mt-auto border-t border-slate-700/30 text-[10px] lg:text-xs text-slate-400 leading-tight lg:leading-relaxed">
                            ...
                            <div className="glass rounded-lg p-2.5 lg:p-3 border border-slate-700/50 bg-gradient-to-br from-slate-800/50 to-slate-900/30">
                              ...
                              {/* Stats Row */}
                              <div className="grid grid-cols-2 gap-2 mb-2 lg:mb-3 p-2 rounded-lg bg-slate-800/30 border border-slate-700/30">
                                <div>
                              ...
                              <div className="mb-1.5 lg:mb-2">
                                <div className="flex items-center justify-between mb-1 lg:mb-1.5 text-xs">
                              ...
                              {/* Limit Info */}
                              <div className="flex items-center justify-between text-[10px] text-slate-500 pt-1 border-t border-slate-700/30 mb-2 lg:mb-3">
                                <span>
                                  {storageQuota 
                              ...
                              <div className="grid grid-cols-2 gap-2 pt-1.5 lg:pt-2 border-t border-slate-700/30">
                                <button
                                  onClick={() => {
                                    try {
                                      exportData()
