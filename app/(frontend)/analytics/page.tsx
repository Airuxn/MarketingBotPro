    ...
    <div className="min-h-screen relative bg-slate-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 lg:py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2.5 lg:gap-3 mb-0.5 lg:mb-0.75">
          ...
          <div className="relative glass rounded-lg border-2 border-blue-500/50 bg-gradient-to-br from-blue-500/15 to-indigo-500/15 shadow-2xl shadow-blue-500/30 hover:shadow-blue-500/40 transition-all duration-300 overflow-hidden" style={{ minHeight: '200px', maxHeight: '220px' }}>
            ...
            <div className="relative p-2.5 lg:p-3 h-full flex flex-col">
              ...
              {insights.recommendations.length > 0 ? (
                <div className="space-y-1 flex-1 overflow-hidden">
                  {insights.recommendations.slice(0, 5).map((rec, idx) => (
                    <div key={idx} className="flex items-start space-x-1.5 lg:space-x-2 text-xs lg:text-sm text-slate-200 leading-relaxed py-1 px-1.5 lg:px-2 rounded-md bg-slate-800/40 hover:bg-slate-800/60 transition-colors border border-blue-500/10">
                      <div className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-1 flex-shrink-0 shadow-lg shadow-blue-400/70 animate-pulse"></div>
                      <span className="flex-1 font-medium">{rec}</span>
                    </div>
                  ))}
                </div>
              ) : (
                <div className="text-xs lg:text-sm text-slate-400 leading-relaxed py-2 px-2.5 rounded-md bg-slate-800/30 border border-blue-500/10 flex-1 flex items-center">
          ...
          {/* Learned Preferences */}
          <div className="relative glass rounded-lg border-2 border-purple-500/50 bg-gradient-to-br from-purple-500/15 to-pink-500/15 shadow-2xl shadow-purple-500/30 hover:shadow-purple-500/40 transition-all duration-300 overflow-hidden" style={{ minHeight: '200px', maxHeight: '220px' }}>
            {/* Animated glow effect */}
            ...
            <div className="relative p-2.5 lg:p-3 h-full flex flex-col">
              ...
              {learnedStyle && Object.keys(learnedStyle).length > 0 ? (
                <div className="space-y-1 flex-1 overflow-hidden">
                  {learnedStyle.length && (
                    <div className="flex items-center justify-between py-1 px-1.5 lg:px-2 rounded-md bg-slate-800/40 hover:bg-slate-800/60 transition-colors border border-purple-500/10">
                ...
                <div className="text-xs lg:text-sm text-slate-400 leading-relaxed py-2 px-2.5 rounded-md bg-slate-800/30 border border-purple-500/10 flex-1 flex items-center">
