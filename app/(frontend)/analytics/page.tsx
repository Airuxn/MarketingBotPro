  ...
  return (
    <div className="min-h-screen relative bg-slate-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 lg:py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2.5 lg:gap-3 mb-0.5 lg:mb-0.75">
          ...
          <div className="relative glass rounded-lg border-2 border-blue-500/50 bg-gradient-to-br from-blue-500/15 to-indigo-500/15 shadow-2xl shadow-blue-500/30 hover:shadow-blue-500/40 transition-all duration-300 overflow-hidden" style={{ height: 'calc(100% * 0.9)' }}>
            ...
            <div className="relative p-1.5 lg:p-2 h-full flex flex-col">
              <div className="flex items-center justify-between mb-1 lg:mb-1.5 flex-shrink-0">
                <div className="flex items-center space-x-1.5 lg:space-x-2">
                  <div className="relative">
                    <div className="absolute inset-0 bg-blue-400/50 rounded-lg blur-lg animate-pulse"></div>
                    <div className="relative w-6 h-6 lg:w-7 lg:h-7 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center shadow-xl shadow-blue-500/50">
                      <Zap className="w-3 h-3 lg:w-3.5 lg:h-3.5 text-white" />
                    </div>
                  </div>
                  <div>
                    <h2 className="text-[10px] lg:text-[11px] font-bold text-white drop-shadow-lg">Performance Insights</h2>
                    <p className="text-[8px] lg:text-[9px] text-blue-300/90 font-medium">AI-powered recommendations</p>
                  </div>
                </div>
              </div>
              {insights.recommendations.length > 0 ? (
                <div className="space-y-0.5 flex-1 overflow-hidden">
                  {insights.recommendations.slice(0, 5).map((rec, idx) => (
                    <div key={idx} className="flex items-start space-x-1 lg:space-x-1.5 text-[9px] lg:text-[10px] text-slate-200 leading-tight py-0.5 px-1 lg:px-1.5 rounded-md bg-slate-800/40 hover:bg-slate-800/60 transition-colors border border-blue-500/10">
                      <div className="w-0.5 h-0.5 lg:w-1 lg:h-1 rounded-full bg-blue-400 mt-1 flex-shrink-0 shadow-lg shadow-blue-400/70 animate-pulse"></div>
                      <span className="flex-1 font-medium">{rec}</span>
                    </div>
                  ))}
                </div>
              ) : (
                <div className="text-[9px] lg:text-[10px] text-slate-400 leading-tight py-1 px-1.5 lg:px-2 rounded-md bg-slate-800/30 border border-blue-500/10 flex-1 flex items-center">
          ...
          <div className="relative glass rounded-lg border-2 border-purple-500/50 bg-gradient-to-br from-purple-500/15 to-pink-500/15 shadow-2xl shadow-purple-500/30 hover:shadow-purple-500/40 transition-all duration-300 overflow-hidden" style={{ height: 'calc(100% * 0.9)' }}>
            ...
            <div className="relative p-1.5 lg:p-2 h-full flex flex-col">
              <div className="flex items-center justify-between mb-1 lg:mb-1.5 flex-shrink-0">
                <div className="flex items-center space-x-1.5 lg:space-x-2">
                  <div className="relative">
                    ...
                    <div className="relative w-6 h-6 lg:w-7 lg:h-7 bg-gradient-to-br from-purple-500 to-pink-600 rounded-lg flex items-center justify-center shadow-xl shadow-purple-500/50">
                      <Brain className="w-3 h-3 lg:w-3.5 lg:h-3.5 text-white" />
                    </div>
                  </div>
                  <div>
                    <h2 className="text-[10px] lg:text-[11px] font-bold text-white drop-shadow-lg">Learned Preferences</h2>
                    <p className="text-[8px] lg:text-[9px] text-purple-300/90 font-medium">Your content style DNA</p>
                  </div>
                </div>
              </div>
              {learnedStyle && Object.keys(learnedStyle).length > 0 ? (
                <div className="space-y-0.5 flex-1 overflow-hidden">
                  {learnedStyle.length && (
                    <div className="flex items-center justify-between py-0.5 px-1 lg:px-1.5 rounded-md bg-slate-800/40 hover:bg-slate-800/60 transition-colors border border-purple-500/10">
                      <span className="text-[9px] lg:text-[10px] text-slate-400 font-medium">Length</span>
                      <span className="text-[9px] lg:text-[10px] text-white font-semibold capitalize px-1 lg:px-1.5 py-0.5 bg-purple-500/30 rounded-md border border-purple-500/50 shadow-md shadow-purple-500/30">{learnedStyle.length}</span>
                    </div>
                  )}
                  {learnedStyle.tone && learnedStyle.tone.length > 0 && (
                    <div className="flex items-center justify-between py-0.5 px-1 lg:px-1.5 rounded-md bg-slate-800/40 hover:bg-slate-800/60 transition-colors border border-purple-500/10">
                      <span className="text-[9px] lg:text-[10px] text-slate-400 font-medium">Tone</span>
                      <span className="text-[9px] lg:text-[10px] text-white font-semibold px-1 lg:px-1.5 py-0.5 bg-purple-500/30 rounded-md border border-purple-500/50 shadow-md shadow-purple-500/30">{learnedStyle.tone.slice(0, 2).join(', ')}</span>
                    </div>
                  )}
                  {learnedStyle.hashtagUsage && (
                    <div className="flex items-center justify-between py-0.5 px-1 lg:px-1.5 rounded-md bg-slate-800/40 hover:bg-slate-800/60 transition-colors border border-purple-500/10">
                      <span className="text-[9px] lg:text-[10px] text-slate-400 font-medium">Hashtags</span>
                      <span className="text-[9px] lg:text-[10px] text-white font-semibold capitalize px-1 lg:px-1.5 py-0.5 bg-purple-500/30 rounded-md border border-purple-500/50 shadow-md shadow-purple-500/30">{learnedStyle.hashtagUsage}</span>
                    </div>
                  )}
                  {learnedStyle.structure && learnedStyle.structure.length > 0 && (
                    <div className="flex items-center justify-between py-0.5 px-1 lg:px-1.5 rounded-md bg-slate-800/40 hover:bg-slate-800/60 transition-colors border border-purple-500/10">
                      <span className="text-[9px] lg:text-[10px] text-slate-400 font-medium">Structure</span>
                      <span className="text-[9px] lg:text-[10px] text-white font-semibold px-1 lg:px-1.5 py-0.5 bg-purple-500/30 rounded-md border border-purple-500/50 shadow-md shadow-purple-500/30">{learnedStyle.structure.slice(0, 2).join(', ')}</span>
                    </div>
                  )}
                </div>
              ) : (
                <div className="text-[9px] lg:text-[10px] text-slate-400 leading-tight py-1 px-1.5 lg:px-2 rounded-md bg-slate-800/30 border border-purple-500/10 flex-1 flex items-center">
        ...
        <div className="glass rounded-lg p-2.5 lg:p-4 border border-slate-700/50 mb-3 lg:mb-6">
          ...
          <ResponsiveContainer width="100%" height={180} className="lg:h-[240px]">
