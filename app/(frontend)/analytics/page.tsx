        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center space-x-3">
            <div className="relative">
              ...
              <div className="relative w-10 h-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center shadow-glow">
                <BarChart3 className="w-5 h-5 text-white" />
              </div>
            </div>
            <div>
              <h1 className="text-2xl font-bold text-gradient mb-1">Analytics Dashboard</h1>
              <p className="text-sm text-slate-300">Track engagement and optimize your content</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
          ...
          {insights.recommendations.length > 0 ? (
            <div className="relative glass rounded-xl p-4 hover-lift border border-blue-500/30 shadow-glow-lg" style={{ boxShadow: '0 0 20px rgba(59, 130, 246, 0.3), 0 0 40px rgba(59, 130, 246, 0.15)' }}>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-sm p-6 border border-blue-100">
              ...
              <div className="glass rounded-lg p-4">
                ...
                <div className="mt-4 pt-4 border-t border-blue-200">
                  <p className="text-xs text-slate-300 mb-2"><strong>Data Sources:</strong></p>
                  <ul className="text-xs text-slate-300 space-y-1 list-disc list-inside">
                    <li>Scanned posts from connected social accounts (Facebook, Instagram, etc.) - automatically included</li>
                    <li>Manually tracked posts - mark as "Posted" and add engagement metrics</li>
                  </ul>
                </div>
                <div className="mt-4 pt-4 border-t border-blue-200">
                  <p className="text-xs text-slate-300 mb-2"><strong>How to add engagement data manually:</strong></p>
                  <p className="text-xs text-slate-300">
                    Go to the "All Posts" section below, click on any post with status "Posted", and enter the engagement metrics (views, likes, comments, shares, reach) from your social media platform.
                  </p>
                </div>
                <div className="mt-4 pt-4 border-t border-blue-200">
                  <p className="text-xs font-semibold text-slate-200 mb-1">What AI Performance Insights analyzes:</p>
                  <ul className="text-xs text-slate-300 space-y-1 list-disc list-inside">
                    <li>Best posting times (day & hour with highest engagement)</li>
                    <li>Best content types (text, image, video performance)</li>
                    <li>Top performing hashtags</li>
                    <li>Platform performance comparison</li>
                    <li>Optimal content length</li>
                    <li>Media impact (with vs without images/videos)</li>
          ...
          {settings.contentPreferences?.learnedStyle && Object.keys(settings.contentPreferences.learnedStyle).length > 0 ? (
            <div className="relative glass rounded-xl p-4 hover-lift border border-purple-500/30 shadow-glow-lg" style={{ boxShadow: '0 0 20px rgba(139, 92, 246, 0.3), 0 0 40px rgba(139, 92, 246, 0.15)' }}>
              ...
              <div className="relative">
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <h2 className="text-lg font-bold text-white">AI Current Learned Preferences</h2>
              </div>
              <div className="space-y-2">
                {settings.contentPreferences.learnedStyle.length && (
                  <div className="flex items-start space-x-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2 flex-shrink-0" />
                      <p className="text-sm text-slate-200">Content length: <span className="font-semibold capitalize">{settings.contentPreferences.learnedStyle.length}</span></p>
                  </div>
                )}
                {settings.contentPreferences.learnedStyle.tone && settings.contentPreferences.learnedStyle.tone.length > 0 && (
                  <div className="flex items-start space-x-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2 flex-shrink-0" />
                      <p className="text-sm text-slate-200">Tone: <span className="font-semibold">{settings.contentPreferences.learnedStyle.tone.slice(0, 3).join(', ')}</span></p>
                  </div>
                )}
                {settings.contentPreferences.learnedStyle.hashtagUsage && (
                  <div className="flex items-start space-x-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2 flex-shrink-0" />
                      <p className="text-sm text-slate-200">Hashtags: <span className="font-semibold capitalize">{settings.contentPreferences.learnedStyle.hashtagUsage}</span></p>
                  </div>
                )}
                {settings.contentPreferences.learnedStyle.emojiUsage && (
                  <div className="flex items-start space-x-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2 flex-shrink-0" />
                      <p className="text-sm text-slate-200">Emojis: <span className="font-semibold capitalize">{settings.contentPreferences.learnedStyle.emojiUsage}</span></p>
                  </div>
                )}
                {settings.contentPreferences.learnedStyle.ctaStyle && settings.contentPreferences.learnedStyle.ctaStyle.length > 0 && (
                  <div className="flex items-start space-x-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2 flex-shrink-0" />
                      <p className="text-sm text-slate-200">CTA style: <span className="font-semibold">{settings.contentPreferences.learnedStyle.ctaStyle.slice(0, 2).join(', ')}</span></p>
                  </div>
                )}
                {settings.contentPreferences.learnedStyle.structure && settings.contentPreferences.learnedStyle.structure.length > 0 && (
                  <div className="flex items-start space-x-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-purple-400 mt-2 flex-shrink-0" />
                      <p className="text-sm text-slate-200">Structure: <span className="font-semibold">{settings.contentPreferences.learnedStyle.structure.slice(0, 3).join(', ')}</span></p>
                  </div>
                )}
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-purple-50/80 to-pink-50/80 rounded-xl shadow-soft p-5 border border-purple-100/60">
              <div className="flex items-center space-x-2 mb-3">
                  ...
                  <div className="mt-3 pt-3 border-t border-purple-200">
                    <p className="text-xs text-purple-700">
                      ...
                      {(!settings.contentPreferences.learnedStyle || Object.keys(settings.contentPreferences.learnedStyle).length === 0) ? (
                        ...
                        <span className="block mt-1 text-green-700">✓ Style learned successfully!</span>
                      )}
                    </p>
                </div>
                )}
          ...
          {insights.bestPostingTimes.length > 0 && (
            <div className="glass rounded-xl p-4 hover-lift">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h3 className="text-base font-semibold text-white">Best Posting Times</h3>
              </div>
              <div className="space-y-2">
                {insights.bestPostingTimes.slice(0, 5).map((time, idx) => (
                  <div key={idx} className="flex items-center justify-between p-2 rounded-lg glass">
                    <div>
                      <span className="font-medium text-white">{time.day}</span>
                      <span className="text-slate-300 ml-2">{time.hour}:00</span>
                    </div>
                    <span className="text-sm font-semibold text-blue-600">
                      {time.avgEngagement.toFixed(1)}% engagement
                    </span>
                  </div>
                ))}
              </div>
          ...
          {insights.bestContentTypes.length > 0 && (
            <div className="glass rounded-xl p-4 hover-lift">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h3 className="text-base font-semibold text-white">Content Type Performance</h3>
              </div>
              <div className="space-y-2">
                {insights.bestContentTypes.map((type, idx) => (
                  <div key={idx} className="flex items-center justify-between p-2 rounded-lg glass">
                    <span className="font-medium text-white capitalize">{type.type}</span>
          ...
          {insights.bestHashtags.length > 0 && (
            <div className="glass rounded-xl p-4 hover-lift">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h3 className="text-base font-semibold text-white">Top Performing Hashtags</h3>
              </div>
              <div className="space-y-2">
                {insights.bestHashtags.slice(0, 10).map((tag, idx) => (
                  <div key={idx} className="flex items-center justify-between p-2 rounded-lg glass">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-slate-400">Used {tag.usageCount}x</div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {insights.bestPlatforms.length > 0 && (
            <div className="glass rounded-xl p-4 hover-lift">
              <div className="flex items-center space-x-2 mb-3">
                ...
                <h3 className="text-base font-semibold text-white">Platform Performance</h3>
              </div>
              <div className="space-y-2">
        ...
        {insights.topPerformingPosts.length > 0 && (
          <div className="glass rounded-xl p-4 mb-4 hover-lift">
            <h3 className="text-base font-semibold text-white mb-3">Top Performing Posts</h3>
            <div className="space-y-3">
              {insights.topPerformingPosts.map((post) => {
                ...
                return (
                  <div
                    key={post.id}
                    className="p-4 rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-sm transition-all duration-300 cursor-pointer"
        ...
        <div className="glass rounded-2xl p-6 hover-lift">
          ...
          {postedPosts.length === 0 ? (
            <div className="text-center py-12 text-slate-400">
              ...
              <p className="text-sm mt-1">Track engagement metrics to see insights here.</p>
            </div>
          ) : (
            <div className="space-y-3">
              {posts
                ...
                .map((post) => {
                  ...
                  return (
                    <div
                      key={post.id}
                      className="p-4 rounded-lg glass border border-slate-700/50 hover:border-purple-500/50 hover:shadow-glow transition-all duration-300 cursor-pointer"
                      onClick={() => setSelectedPost(post.id)}
                    >
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex-1">
